...
const NAV_ITEMS = [
  ...
  { page: "dental-material", label: "Dental Material", short: "DM", section: "Receptionist", roles: ["receptionist"] },
  ...
  { page: "lab-records", label: "Lab Records", short: "LR", section: "Clinic", roles: ["admin", "receptionist"] },
